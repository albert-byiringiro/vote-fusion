...
export default (
    ...
    /*
    1. Each value of of `ranking` key values is an array of a participant's votes. Points for each array element corresponds to following formula:
    r_n = ((votesPerVoter - 0.5 * n) / votesPerVoter) ^ (n + 1), where n corresponds to array index of rankings.
    */
    ...
    // 2. Take nominationID to score mapping, and merge in nominationText and nominationID into value
